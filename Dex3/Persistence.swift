...
struct PersistenceController {
    ...
    static var preview: PersistenceController = {
        ...
        samplePokemon.shinySprite = URL(string: "https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/shiny/1.png")
    ...
    init(inMemory: Bool = false) {
        ...
        if inMemory {
            ...
            container.persistentStoreDescriptions.first!.url = FileManager.default.containerURL(forSecurityApplicationGroupIdentifier: "group.com.tiagopinheiro.Dex3")!.appending(path: "Dex3.sqlite")
        }
